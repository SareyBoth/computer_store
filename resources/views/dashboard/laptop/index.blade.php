...
@section('content_header')
    <div class="d-flex justify-content-between mx-4">
        <h1>Drinks Table</h1>
        <div>
            <form action="{{ route('laptop.create') }}" method="GET" style="display: inline;">
                ...
                <tbody>
                    @foreach ($laptops as $index)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('laptop.edit', $index->id) }}" class="btn btn-secondary btn-sm">Update</a>
                                <!-- Delete Form -->
                                <form action="{{ route('laptop.destroy', $index->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
