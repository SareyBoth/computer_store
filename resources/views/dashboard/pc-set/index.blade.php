...
@section('content_header')
    <div class="d-flex justify-content-between mx-4">
        <h1>Drinks Table</h1>
        <div>
            <form action="{{ route('pc_set.create') }}" method="GET" style="display: inline;">
...
@section('content')
                ...
                <tbody>
                    @foreach ($pcSets as $index)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('pc_set.edit', $index->id) }}" class="btn btn-secondary btn-sm">Update</a>
                                <!-- Delete Form -->
                                <form action="{{ route('pc_set.destroy', $index->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
    ...
    <div class="pagination-container mt-5 mb-5 d-flex justify-content-end">
        {{ $pcSets->links('pagination::bootstrap-4') }}
    </div>
@stop
