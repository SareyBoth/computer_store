    ...
    <div class="mx-80 mt-8">
        ...
        <div id="asus" >
            ...
            <div>
                ...
                <?php $__currentLoopData = $asus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                            <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                        </div>
                        <div class="border border-gray-200 px-4 pt-8">
                            <p class="text-center font-semibold text-blue-500 text-lg"><?php echo e($laptop->name); ?></p>
                            <p class="text-center text-3xl font-bold text-red-500 mt-2">$ <?php echo e($laptop->price); ?></p>
                            <div class="pt-4">
                                <p>CPU     : <span class="text-blue-500 font-semibold"><?php echo e($laptop->cpu); ?></span></p>
                                <p>RAM     : <span class="text-red-500 font-semibold"><?php echo e($laptop->ram); ?></span></p>
                                <p>Storage : <span class="font-semibold"><?php echo e($laptop->storage); ?></span></p>
                                <p>Graphic : <span class="font-semibold"><?php echo e($laptop->graphic); ?></span></p>
                                <p>Display : <span class="font-semibold"><?php echo e($laptop->display); ?></span></p>
                                <p>OS      : <span class="font-semibold"><?php echo e($laptop->os); ?></span></p>
                                <p>Battery : <span class="font-semibold"><?php echo e($laptop->battery); ?></span></p>
                                <p>Weight  : <span class="font-semibold"><?php echo e($laptop->weight); ?></span></p>
                                <p>Warranty : <span class="font-semibold"><?php echo e($laptop->warranty); ?></span></p>
                            </div>
                            <div class="py-2">-------------------------------</div>
                        </div>
                    </div>
            ...
            <div>
                ...
                <?php $__currentLoopData = $rog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                            <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                        </div>
        ...
        <div>
            <div id="msi" >
                ...
                <div>
                    ...
                    <?php $__currentLoopData = $msi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                            <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                        </div>
         ...
         <div>
            <div id="lenovo" >
                ...
                <div>
                    ...
                    <?php $__currentLoopData = $lenovo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                                <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                            </div>
        ...
        <div>
            <div id="dell" >
                ...
                <div>
                    <div class=" grid grid-cols-3 gap-[0.2px] mt-8" id="lenovoLaptopLoop">
                    <?php $__currentLoopData = $alienware; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                                <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                            </div>
        ...
        <div>
            <div id="microsoft" >
                ...
                <div>
                    ...
                    <?php $__currentLoopData = $microsoft; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                                <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                            </div>
        ...
        <div>
            <div id="gigabyte" >
                ...
                <div>
                    ...
                    <?php $__currentLoopData = $gigabyte; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laptop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="border border-gray-200 p-12 text-center relative h-[250px]">
                                <img class="w-[220px] mix-blend-multiply top-0 bottom-0 right-0 left-0 p-auto m-auto" src="<?php echo e(asset($laptop->image)); ?>" alt="<?php echo e($laptop->name); ?>">
                            </div>
...
</html><?php /**PATH /home/sareyboth/Desktop/computer store/resources/views/page/home.blade.php ENDPATH**/ ?>