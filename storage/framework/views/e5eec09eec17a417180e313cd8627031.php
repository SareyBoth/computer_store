...
<?php $__env->startSection('content'); ?>
    <div class="box">
        ...
        <form method="POST" action="<?php echo e(route('accessory.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <label for="brand">Brand*</label>
                        <select class="form-control" id="brand" name="brand" required>
                            ...
                            <option value="dxracer">DX Racer</option>
                            <option value="logitech">Logitech</option>
                            <option value="hyperx">Hyper x</option>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sareyboth/Desktop/computer store/resources/views/dashboard/accessory/create.blade.php ENDPATH**/ ?>