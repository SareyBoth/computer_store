...
<?php $__env->startSection('content'); ?>
    <div class="box">
        ...
        <form method="POST" action="<?php echo e(route('laptop.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="box-body">
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sareyboth/Desktop/computer store/resources/views/dashboard/laptop/create.blade.php ENDPATH**/ ?>