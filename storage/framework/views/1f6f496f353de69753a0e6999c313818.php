...
<?php $__env->startSection('title', 'Create Laptop'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="box">
        ...
        <form method="POST" action="<?php echo e(route('pc_hardware.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <label for="type">Type*</label>
                        <select class="form-control" id="type" name="type" required>
                            ...
                            <option value="intel">Intel MotherBoard</option>
                            <option value="amd">AMD MotherBoard</option>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sareyboth/Desktop/computer store/resources/views/dashboard/pc-hardware/create.blade.php ENDPATH**/ ?>